...
const DISCLAIMER =
  "Individual results vary. Statistics shown reflect anonymized self-reported outcomes from members of the Halo weight loss program. All results refer to participation in the full program—which combines physician oversight, nutrition support, and, when clinically appropriate, FDA-approved GLP-1 medication or compounded GLP-1 medication dispensed by licensed pharmacies; no efficacy claims are made for any compounded drugs. Medication eligibility and outcomes depend on individual clinical evaluation. Common GLP-1 side effects include nausea and constipation. Consult a licensed medical professional to determine whether GLP-1 therapy within the Halo program is appropriate for you. The individual pictured is not necessarily a Halo member. Customer results have not been independently verified.";
